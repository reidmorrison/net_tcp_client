...
def create_client(with_ssl, params={})
  params = params.dup
  if with_ssl
    params.merge!(
      ssl: true,
...
module Net
  class ClientTest < Minitest::Test
    describe TCPClient do
      [true, false].each do |with_ssl|
        describe (with_ssl ? 'without ssl' : 'with ssl') do
